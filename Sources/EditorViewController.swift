...
//			UIKeyCommand(input: "d", modifierFlags: [.Command], action: #selector(inlineCode), discoverabilityTitle: LocalizedString.InlineCodeCommand.string),
			...
			UIKeyCommand(input: "]", modifierFlags: [.Command], action: #selector(increaseBlockLevel), discoverabilityTitle: LocalizedString.IndentCommand.string),
			UIKeyCommand(input: "\t", modifierFlags: [], action: #selector(increaseBlockLevel)),
			UIKeyCommand(input: "[", modifierFlags: [.Command], action: #selector(decreaseBlockLevel), discoverabilityTitle: LocalizedString.OutdentCommand.string),
			UIKeyCommand(input: "\t", modifierFlags: [.Shift], action: #selector(decreaseBlockLevel))
		]
